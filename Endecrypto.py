...
image_image_1 = PhotoImage(
    file=os.path.join(basedir, "assets", "image_1.png"))
...
entry_image_1 = PhotoImage(
    file=os.path.join(basedir, "assets", "entry_1.png"))
...
button_image_1 = PhotoImage(
    file=os.path.join(basedir, "assets", "button_1.png"))
...
button_image_2 = PhotoImage(
    file=os.path.join(basedir, "assets", "button_2.png"))
...
button_image_3 = PhotoImage(
    file=os.path.join(basedir, "assets", "button_3.png"))
